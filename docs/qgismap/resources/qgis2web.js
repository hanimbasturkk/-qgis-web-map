...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [24.607998, 32.020293, 44.714892, 45.699573], maxZoom: 10, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [25.668509, 35.808419, 44.817931, 42.104786],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([24.607998, 32.020293, 44.714892, 45.699573], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_tur_polbnda_adm1_0,
    colName: 'risk_etiketi',
    zoom: 10,
    collapsed: true,
    map: map
});
